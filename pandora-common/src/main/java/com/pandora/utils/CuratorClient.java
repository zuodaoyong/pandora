...
public class CuratorClient {
    ...
    public CuratorClient(String connectString, int timeout) {
        this(connectString, Constants.Zookeeper.ZK_NAMESPACE, timeout, timeout);
    }

    public CuratorClient(String connectString) {
        this(connectString, Constants.Zookeeper.ZK_NAMESPACE, Constants.Zookeeper.ZK_SESSION_TIMEOUT, Constants.Zookeeper.ZK_CONNECTION_TIMEOUT);
    }
